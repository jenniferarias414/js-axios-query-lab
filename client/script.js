...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get('http://localhost:3000/repeat/boogie').then((res) => {
        console.log(res.data)
...
let repeatParamBtn = document.querySelector('#repeat-button')
repeatParamBtn.addEventListener('click', repeatMyParam)
...
// CODE HERE
const attachQuery = () => {
axios.get('http://localhost:3000/query-test?name=bob').then((res) => {
     console.log(res.data)
})
}
